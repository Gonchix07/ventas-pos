...
/**
 * Dashboard de ventas — antes vivía dentro de Administración (/admin/ventas), promovido a módulo
 * propio del menú principal. Por eso tiene su propio encabezado (usuario/IP/Salir), igual que
...
export function VentasPage() {
  ...
  return (
    <div className="app-shell">
      ...
      {/* admin-content-full: mismo criterio que tenía dentro de Admin — sin el ancho fijo de un
          ABM, estirado a todo el alto visible (útil con muchos gráficos lado a lado). Esa regla le
          fuerza flex-direction:column a los HIJOS DIRECTOS de admin-content-full (pensada para
          cuando Ventas vivía en un único <div> dentro del Outlet de Admin) — por eso todo el
          contenido va en un único <div> interno, para que .page-head/.filter-bar/etc. queden como
          nietos y no hijos directos, y no se les fuerce esa dirección de flex. */}
      <main className="app-main admin-content-full">
      <div>
        ...
        <div className="filter-bar filter-bar-center">
          ...
          <label style={{ maxWidth: 260 }}>Sucursal
